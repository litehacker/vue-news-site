        ...
        <div class="container p-0">
            ...
            >
                <div class="navbar-collapse">
                    <div
                        class="navbar-nav custom-topmenu-link w-100"
        ...
        <div class="container-sm position-relative p-0">
            ...
            <nav class="navbar navbar-expand-lg d-lg-none navbar-dark">
                <div
                    ...
                    style="background-color: rgb(4, 43, 64)"
                >
                    <a
                    ...
                    <div
                        class="collapse navbar-collapse row mx-1 mb-1"
                            ...
                            <div class="to-hover justify-content-center d-flex">
                                ...
                                >
                                    <div class="d-flex container p-0 mb-0">
                                        <div
                                            class="row justify-content-start col-10"
                                        >
                                            <li
                                                class="col-3 p-3"
            ...
            <!-- mobile NAV BAR END -->
            <form
                class="d-flex position-absolute bottom-0 end-0 py-4 d-none d-lg-grid"
            >
                <input
                ...
                />
                <button
                    class="btn btn-light border-left-none"
                    type="submit"
                ></button>
            </form>
        </div>
            ...
            <nav class="navbar navbar-dark container p-0">
                <div class="navbar-collapse d-none d-lg-block d-lg-flex">
                    ...
                    >
                        ...
                        <div
                            :class="`d-none d-lg-block arrow-down-${index + 1}`"
                        ></div>
                    </div>
                </div>
            </nav>
            ...
            headerMenuLinks: [
                ...
                },
                {
                    ...
                    subCategories: [
                        ...
                        {
                            title:
                                "სათაური 30 სათაური 30 სათაური 30 სათაური 30",
                            imageUrl: "/static/images/dummy_slide.jpg",
                            url: "/subcat",
                        },
                    ],
